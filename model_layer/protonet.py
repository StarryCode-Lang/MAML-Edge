...
from .experiment import build_dataset_from_args, build_encoder_from_args, get_model_config
from .utils import (
...
def create_datasets(args):
    ...
    for domain in args.train_domains:
        dataset = build_dataset_from_args(args, domain)
...
def create_model(args, device):
    model = build_encoder_from_args(args)
    model.to(device)
