...
from model_layer.utils import generate_time_frequency_image_dataset, normalize, setup_logger
...
def load_CWRU_dataset(
    ...
    selected_labels = DEFAULT_LABELS if labels is None else [int(label) for label in labels]
    # dataset {class label : data list of this class}
    # e.g., {0: [data1, data2, ...], 1: [data1, data2, ...], ...}
    dataset = {label: [] for label in selected_labels}
